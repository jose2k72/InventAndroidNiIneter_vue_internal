# Archivo de Cambios - Febrero 2026
...
### [2026-02-08] - Posición Relativa y Tablas Adyacentes
...
#### 🗄️ DatabaseHelper.kt
- Actualizado `getDataInAdjacentPolygons()` para calcular la dirección relativa y ordenar resultados.
